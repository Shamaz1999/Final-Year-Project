...
class About extends Component {
    ...
    render(){
        return(
            ...
            <div class="jumbotron">
    <div class="shadow-lg ">
      <h1 class="display-3 big-headings"><b>Citizens Bank</b></h1>
    </div>
    <p class="heading-3 med-headings">Bright Future</p>
    <p class="about-detail">“Everyday is a bank account, and time is our currency. No one is rich, no one is poor, we've got 24 hours each. It
      ...
      <a href="contact.html"><button class="btn cont-btn login-btn" role="button">Contact Us</button></a>
  </div>
        ...
        <div class="section">
            ...
            <h5 class="text-center">
                <div class="container about-detail ">
                  The website we are offering has a very simple yet attractive interface for users who are new to online banking. The
                  features of this website include a lite design, account management (updating or deleting accounts), online transactions
                  (deposit or withdraw), transactions log. There is also an administration contact page for any complains. The main
                  aim of this website is to make online banking more reliable, user-friendly and to attract more users to shift to
                  online banking.
                </div>
            </h5>
        </div>
        ...
        <div class="col-md-4">
          <div class="aside">
            ...
            <ul class="aim-ul about-detail" type="square">
              <li>Provide easiast way of online banking.</li>
              <li>User create account easily.</li>
              <li>Check account detail.</li>
              <li>User Easily modify acount detail.</li>
              <li>furture detail please Contact us.</li>
              <a href="contact.html"><button class="btn login-btn" role="button">Contact Us</button></a>
            </ul>
