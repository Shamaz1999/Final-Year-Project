                    ...
                    <div className="tabs-shadow signup-form-wrapper">
                        <div className="login-form-container">
                            <div className="form-group">
                                ...
                                <input type="text" name="adTitle" id="adTitle" ref="adTitle" onInput={e => this.setState({ adTitle: e.target.value })} className="form-control" placeholder="Ad Title Here" />
                            </div>
                            <div className="form-group">
                                <label className="signup-label" htmlFor="itemBrand"><b>Item Brand</b> <span className="required">*</span></label>
                                <input type="text" name="brand" id="itemBrand" onInput={e => this.setState({ brand: e.target.value })} ref="itemBrand" className="form-control" placeholder="Item Brand Here" />
                            </div>
                            <div className="form-group">
                                <label className="signup-label" htmlFor="adCategory"><b>Item Category</b> <span className="required">*</span></label>
                                <select id="adCategory" className="form-control" onInput={e => this.setState({ category: e.target.value })} name="adCategory" ref="adCategory">
                            ...
                            <div className="form-group">
                                ...
                                <input type="number" name="adPrice" id="adPrice" ref="adPrice" onInput={e => this.setState({ price: e.target.value })} className="form-control" placeholder="Item Price Here" />
                            </div>
                            <div className="form-group">
                                <label className="signup-label" htmlFor="adloc"><b>Location</b> <span className="required">*</span></label>
                                <input type="text" name="adloc" id="adloc" ref="adloc" onInput={e => this.setState({ location: e.target.value })} className="form-control" placeholder="Your location Here" />
                            </div>
                            <div className="form-group">
                                <label className="signup-label" htmlFor="exampleInputEmail1"><b>Upload Pictures</b> <span className="required"><span style={{ fontSize: '14px' }}>(after selecting files click on upload)</span>*</span></label>
                                <div class="ad-img-upload-container">
                                    ...
                                    <div className="imgupload1">
                                        ...
                                        <img ref='img1' alt="image1" id="upImg1" src={this.state.url1} className="hid" height="30" />
                                    </div>
                                    <div className="imgupload1">
                                        ...
                                        <img ref='img2' alt="image2" id="upImg2" src={this.state.url2} className="hid" height="30" />
                                    </div>
                                    <div className="imgupload1">
                                        ...
                                        <img ref='img3' alt="image3" id="upImg3" src={this.state.url3} className="hid" height="30" />
                                    </div>
                                    <div className="imgupload1">
                                        ...
                                        <img ref='img4' alt="image4" id="upImg4" src={this.state.url4} className="hid" height="30" />
                                    </div>
                                </div>
                            </div>
                            <div className="form-group">
                                <label className="signup-label" htmlFor="adDesc"><b>Description</b> <span className="required">*</span></label>
                                <textarea name="adDesc" id="adDesc" ref="adDesc" onInput={e => this.setState({ description: e.target.value })} className="form-control" style={{ resize: 'none' }} rows="5"></textarea>
                            </div>
                            <div className="form-group">
                                <label className="signup-label" htmlFor="phone-num"><b>Phone Number</b> <span className="required">*</span></label>
                                <PhoneInput className="form-control custom-phone1" ref="userNum" id="phone-num" placeholder="Enter phone number" value={this.state.phone} onChange={phone => this.setState({ phone })} />
                            </div>
                            <br />
